    ...
    <section id="services" class="services">
      <div class="container">
        ...
        <div class="section-title">
          <h2><?php echo "Exciting Deals"?></h2>
          <p><?php echo "Peace, Love and Ice Cream · Is Your Mouth Watering Yet? Taste the Feeling of Freedom · Don't Kill Your Dreams  Just Chill with Us <3"?></p>
        </div>

        <div class="row">
          <div class="col-lg-4 col-md-6">
            <div class="icon-box">
              <h4 class="title"><a href=""><?php echo "Loyalty Card"?></a></h4>
              <p class="description"><?php echo "Encourage repeat customers with the Ice Cream Loyalty Card. The more you shop, the more you receive in return. "?></p>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 mt-4 mt-md-0">
            <div class="icon-box">
              <h4 class="title"><a href=""><?php echo "Buy One Get One Promo"?></a></h4>
              <p class="description"><?php echo "Everyone actually likes freebies.Get a chance to get a free ice cream product if purchase the premium one"?></p>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 mt-4 mt-lg-0">
            <div class="icon-box">
              <h4 class="title"><a href=""><?php echo "Seasonal Discounts & Offers"?></a></h4>
              <p class="description"><?php echo "Seasonal promotions are special offers, discounts, or special edition products associated with a specific event throughout the year."?></p>
            </div>
          </div>
          </div>
        </div>
