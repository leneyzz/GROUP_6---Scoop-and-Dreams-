    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row content">
          <div class="col-lg-6">
            <p>
            <?php echo "At Scoops & Dreams, we create delectable ice cream flavors using the finest ingredients and artisanal craftsmanship. Our mission is to bring joy to people's lives through our unforgettable frozen treats. Join us for a delightful journey of flavor, joy, and endless possibilities. Welcome to Scoops & Dreams!"?>
            </p>
            <ul>
              <li><i class="ri-check-double-line"></i><?php echo "Soft serve for everyone!"?></li>
              <li><i class="ri-check-double-line"></i><?php echo "Low-Sodium"?></li>
              <li><i class="ri-check-double-line"></i><?php echo "Cheap Ice Cream Offers!"?></li>
            </ul>
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0">
            <p>
            <?php echo "Ice cream is a frozen dessert, typically made from milk or cream and flavoured with a sweetener, either sugar or an alternative, and a spice, such as cocoa or vanilla, or with fruit such as strawberries or peaches. It can also be made by whisking a flavored cream base and liquid nitrogen together."?>
            </p>
            <a href="#" class="btn-learn-more"><?php echo "Learn More"?></a>
          </div>
        </div>
